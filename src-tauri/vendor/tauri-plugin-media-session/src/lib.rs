...
pub struct MediaState {
    ...
    /// Whether shuffle is currently enabled (shows a shuffle button in the notification).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub shuffle_enabled: Option<bool>,
    /// Current repeat mode: "off", "one", or "all" (shows a repeat button in the notification).
    #[serde(skip_serializing_if = "Option::is_none")]
